...
export const metadata: Metadata = {
  ...
  description:
    "Private Avalanche builders who ship weekly, publicly, on mainnet. No grants. No BS.",
  alternates: {
          ...
          <div className="space-y-12">
            ...
            <div>
              <p className="text-xl text-black leading-relaxed">
                We're a private sprint program for Avalanche builders. Ship weekly, publicly, on
                mainnet. We start with 25 builders and run rolling admission.
              </p>
              ...
              <p className="text-lg text-black/80 leading-relaxed mt-6">
                If you haven't deployed a{" "}
                <strong>user-visible mainnet artifact in the last 60 days</strong>, this isn't for
                you.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 ml-6 mb-8">
                ...
                <p className="text-lg text-black/90 leading-relaxed">
                  • Contract address + deployment txn
                </p>
                <p className="text-lg text-black/90 leading-relaxed">
                  • Merged PR powering a live service
                </p>
                <p className="text-lg text-black/90 leading-relaxed">
                  • ≤60-second demo showing it works
                </p>
              </div>
              <p className="text-base text-black/70 leading-relaxed mb-6">
                Infra counts if it serves live traffic. Testnet is allowed every other week (week 1
                → testnet, week 2 → mainnet, week 3 → testnet, rinse and repeat).
              </p>
            ...
            <div>
              ...
              <p className="text-lg text-black/90 leading-relaxed">
                Rolling admission. Dynamic membership. We start with 25 builders and adjust as
                needed. Ship or leave. Re-apply anytime after shipping a new mainnet artifact.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-base text-black/70 leading-relaxed mt-2">
                    Why hasn't anyone built a HyperLiquid-style product on an Avalanche L1? → start
                    building it.
                  </p>
                </div>
                <div>
              ...
              <div className="mt-8 mb-6 text-center">
                <p className="text-base text-black/60 italic">
                  ...
                  <br />
                  You can build anything you want, it just has to be on Avalanche, high quality and
                  serve a purpose.
                </p>
              </div>
              <div className="mt-8 p-4 bg-gray-50 border-l-4 border-black">
                <p className="text-base text-black/70 leading-relaxed">
                  This is <strong>NOT</strong> a place for NFT collection launches.
                  <br />
                  This is <strong>NOT</strong> a place for memecoin launches.
                  <br />
            ...
            <div>
              ...
              <p className="text-lg text-black/90 leading-relaxed mb-4">
                C-Chain delivers fast blocks, fast finality, low gas, deep liquidity, and{" "}
                <strong>natively issued stablecoins</strong>. L1s let you customize everything—gas
                token, precompiles, consensus, etc. Everything is EVM compatible.
              </p>
              <p className="text-lg text-black/90 leading-relaxed">
            ...
            <div>
              ...
              <div className="mb-8">
                ...
                <p className="text-base text-black/70 leading-relaxed">
                  ~5-10 hours/week. Two-week sprints. One weekly call, async reviews, ship your
                  thing.
                </p>
              </div>
              ...
              <div className="mt-8 p-6 bg-gray-50 border-l-4 border-[#E84142]">
                ...
                <p className="text-base text-black/70 leading-relaxed">
                  If you can't get yourself out of bed and ship something every week, no one will
                  save you. We rely on each other for high-impact items—social connections, novel
                  ideas, recommendations on SDKs and integrations. We amplify each other publicly.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-black/60 mb-6 italic">
                Membership is dynamic. Ship or leave. Re-apply anytime after shipping a new mainnet
                artifact.
              </p>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="space-y-2 text-base text-black/90">
                    <li className="leading-relaxed">
                      Fail to ship within <strong>14 days</strong> of joining →{" "}
                      <strong className="text-red-600">removed</strong> (extensions only for
                      pre-approved blockers)
                    </li>
                    <li className="leading-relaxed">
                      Miss <strong>two demos</strong> without ≥12h notice →{" "}
                      <strong className="text-red-600">removed</strong>
                    </li>
                    <li className="leading-relaxed">
                      Ghost <strong>7 days</strong> during an active sprint →{" "}
                      <strong className="text-red-600">removed</strong> (posting weekly artifacts =
                      not ghosted)
                    </li>
                    <li className="leading-relaxed">
                      Ignore a tagged blocker for <strong>24h</strong> →{" "}
                      <strong className="text-red-600">removed from reviewer bench</strong> for the
                      sprint
                    </li>
                    <li className="leading-relaxed">
                      Low quality ship / clear lack of effort →{" "}
                      <strong className="text-red-600">removed</strong>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-base text-black/90">
                    <li className="leading-relaxed">
                      You talk shit about the community or the program instead of helping each other
                    </li>
                    <li className="leading-relaxed">
                      You only complain about factors outside of your control
                    </li>
                    <li className="leading-relaxed">
                      You make deceptive security claims about your own project
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base text-black/90 leading-relaxed">
                    No public claims of features, tokens, or partnerships before users can touch it.
                    NDA partner updates are fine.
                  </p>
                </div>
            ...
            <div>
              ...
              <p className="text-lg text-black/90 leading-relaxed mb-4">
                <strong>Individuals only.</strong> Inside the community, members may form small
                groups ≤3 people.
              </p>
              <p className="text-lg text-black/90 leading-relaxed mb-4">
                We want: Engineers (contracts, frontend, bots, infra). Product/design/operators who
                turn "works for 10" into "works for 10,000."
              </p>
              <p className="text-lg text-black font-semibold leading-relaxed">
                Hard requirement: You've shipped code, deployed contracts, or run infra{" "}
                <strong>within 60 days</strong>. The application process requires proof of work and
                your GitHub handle.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-base text-black/90">
                <li className="leading-relaxed">
                  Links to your last 2 ships (≤60 days): URL / repo / PR / contract / txn
                </li>
            ...
            <div>
              ...
              <p className="text-lg text-black/90 leading-relaxed mb-4">
                Your reward: accountability, feedback from experienced builders, and a forcing
                function to ship consistently.
              </p>
              <p className="text-lg text-black/90 leading-relaxed">
                <strong>External grants:</strong> Allowed outside the program. Disclose conflicts if
                they affect sprint priorities.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-base text-black/80 mt-1">
                    No. Individuals apply. You may form groups ≤3 inside the community.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-lg text-black">Can I use testnet?</p>
                  <p className="text-base text-black/80 mt-1">
                    Yes, every other week. Alternate between testnet and mainnet demos.
                  </p>
                </div>
                <div>
                  <p className="font-semibold text-lg text-black">What if I miss a demo?</p>
                  <p className="text-base text-black/80 mt-1">
                    Give ≥12h notice. Miss two without notice → removed. Miss three regardless of
                    notice → removed.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-base text-black/80 mt-1">
                    Yes. Anytime after shipping a new mainnet artifact.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-base text-black/80 mt-1">
                    Launch on Avalanche first. Add other chains later if it helps users.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              <p className="text-sm text-black/50 italic">
                Participation does not constitute investment advice, partnership, employment, or
                endorsement. You own what you ship.
              </p>
            </div>

            {/* CTA */}
            <div className="pt-8 text-center">
              <p className="text-2xl font-bold text-black leading-relaxed">Ready to build?</p>
              <p className="text-2xl font-bold text-[#E84142] mt-2">Let's fucking ship.</p>
              <div className="mt-8">
                <Link
                  href="/"
