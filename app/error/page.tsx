...
function ErrorContent() {
  ...
  useEffect(() => {
    ...
    const errorMessages: Record<string, string> = {
      ...
      AccessDenied:
        'Access was denied. You may have cancelled the login or do not have permission.',
      Verification: 'The verification link has expired or has already been used.',
      OAuthAccountNotLinked:
        'This account is already connected to a different user. Please use another account.',
